let number  = parseInt(prompt("Digita un primer número: "));
let number2 = parseInt(prompt("Digita un segundo número: "));
let number3 = parseInt(prompt("Digita un tercer número: "));
